...
int main(int argc, char *argv[]) {
    ...
    err = cudaMallocManaged((void**)&d_padded, paddedHeight*paddedWidth*sizeof(float));
    ...
    err = cudaMallocManaged((void**)&d_filter, filterHeight*filterWidth*sizeof(float));
    ...
    err = cudaMallocManaged((void**)&d_output, inputHeight*inputWidth*sizeof(float));
